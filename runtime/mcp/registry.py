    ...
    def _register_initial_tools(self):
        ...
        initial_tools = [
            ...
            ToolDefinition(
                ...
                description="Inspects a checked-out repository inside the governed Runtime workspace.",
                input_schema={"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]},
                output_schema={"type": "object", "properties": {"path": {"type": "string"}, "exists": {"type": "boolean"}, "is_git_repository": {"type": "boolean"}, "head": {"type": ["string", "null"]}}},
                required_capability="repository.inspect",
                network_requirement="none",
                timeout=30,
                version="1.0.0",
                state=ToolState.AVAILABLE,
                tags=["repository", "inspect", "read"],
            ),
            ToolDefinition(
                tool_id="repository.read",
                name="Repository Read",
                description="Reads file content from a checked-out repository workspace.",
                input_schema={"type": "object", "properties": {"file_path": {"type": "string"}}, "required": ["file_path"]},
                output_schema={"type": "object", "properties": {"content": {"type": "string"}, "size": {"type": "integer"}}},
                required_capability="repository.read",
                network_requirement="none",
                timeout=30,
                version="1.0.0",
                state=ToolState.AVAILABLE,
        ...
        initial_policies = [
            ...
            ToolPolicy(
                ...
                require_evidence=True,
                allowed_callers=["repository.read"],
                network_policy="disabled",
                filesystem_policy="read_only",
                audit_level="summary",
            ),
