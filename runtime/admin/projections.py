...
def default_projection_registry() -> ProjectionRegistry:
    ...
    items = [
        ...
        _p("admin.operations", "Operations", "Execution", priority="P1", source_authority="RUNTIME_EXECUTION", route_or_detail="/operations", implementation_status="BOUND", sort_order=205, tags=("operations",)),
        _p("admin.receipts", "Receipts", "Evidence / Provenance", priority="P1", source_authority="RECEIPT_STORE", route_or_detail="/receipts", implementation_status="BOUND", sort_order=185, tags=("receipts",)),
        ...
        _p("execution.missions", "Missions", "Execution", priority="P0", source_authority="RUNTIME_EXECUTION", route_or_detail="/execution/missions", implementation_status="PARTIAL", sort_order=196, tags=("execution", "missions")),
