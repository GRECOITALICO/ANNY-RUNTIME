...
class ThreePlaneBootstrap:
    ...
    def __init__(
        ...
        # This is an injected external client boundary, not a local CONRRAD
        # implementation. A missing client must fail closed before GitHub.
    ...
    def resolve(self) -> BootstrapReport:
        ...
        # ---------------------------------------------------------
        # PLANE 4: Repository Fabric (Requires Identity + CONRRAD + GitHub)
        # ---------------------------------------------------------
